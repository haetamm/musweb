...
const PlaylistCollabPage = async ({
  searchParams,
}: {
  ...
  const { data, error } =
    await PlaylistAction.getPlaylistCollaboration(currentPage);
    ...
    <div className="lg:px-4">
      ...
      {_pagination.total > 10 && (
        <Pagination
          ...
          baseUrl={urlPage.PLAYLIST_COLLAB}
        />
      )}
    </div>
  );
...
export default PlaylistCollabPage;
